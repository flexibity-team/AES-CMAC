...
int main(int argc, const char *argv[]) {
	...
	uint8_t key_cbc_raw[] = { 0x2b, 0x7e, 0x15, 0x16, 0x28, 0xae, 0xd2, 0xa6,
			0xab, 0xf7, 0x15, 0x88, 0x09, 0xcf, 0x4f, 0x3c };

	uint8_t const_Zero = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };

	uint8_t const_Rb = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x87 };

	uint8_t k1[] = { 0x12, 0x20, 0x30, 0x40, 0x50, 0x60, 0x70, 0x80, 0x90, 0xa0,
			0xb0, 0xc0, 0xd0, 0xe0, 0xf0, 0x00 };

	uint8_t k2[] = { 0x13, 0x20, 0x30, 0x40, 0x50, 0x60, 0x70, 0x80, 0x90, 0xa0,
			0xb0, 0xc0, 0xd0, 0xe0, 0xf0, 0x00 };

	uint8_t kiv[] = { 0x14, 0x20, 0x30, 0x40, 0x50, 0x60, 0x70, 0x80, 0x90,
			0xa0, 0xb0, 0xc0, 0xd0, 0xe0, 0xf0, 0x00 };
	...
	if (0 != aes_cbc_decript(newdata, lenNew, key_cbc_raw, iv, kiv)) {
		printf(
